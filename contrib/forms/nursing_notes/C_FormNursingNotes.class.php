...
require_once(__DIR__ . "/FormNursingNotes.class.php");
...
class C_FormNursingNotes extends Controller
{
    ...
    {
        $formNursingNotes = new FormNursingNotes();
        $this->assign("data", $formNursingNotes);
        return $this->fetch($this->template_dir . $this->template_mod . "_new.html");
    }

    public function view_action($form_id)
    {
        $form = is_numeric($form_id) ? new FormNursingNotes($form_id) : new FormNursingNotes();
