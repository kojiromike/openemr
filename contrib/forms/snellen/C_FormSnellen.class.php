...
require_once(__DIR__ . "/FormSnellen.class.php");
...
class C_FormSnellen extends Controller
{
    ...
    {
        $formSnellen = new FormSnellen();
        $this->assign("data", $formSnellen);
        return $this->fetch($this->template_dir . $this->template_mod . "_new.html");
    }

    public function view_action($form_id)
    {
        $form = is_numeric($form_id) ? new FormSnellen($form_id) : new FormSnellen();
