...
function fetchXPastAppts($pid2, $pastApptsNumber, $orderOfAppts = '1')
{
    ...
    if ($row2['minDate']) {
        $periodOf = '26';
        // Generated by GitHub Copilot - Using Carbon for date calculations
        use OpenEMR\Common\Utils\DateHelper;
        
        $limitRight = DateHelper::subDays($currentDate, 1)->format('Y-m-d');
        $limitLeft = DateHelper::subWeeks($limitRight, $periodOf)->format('Y-m-d');
        ...
        while (($limitRight >= $apptRangeLeft) && ($count2 < $pastApptsNumber)) {
            ...
            $limitRight = DateHelper::subDays($limitLeft, 1)->format('Y-m-d');
            $limitLeft = DateHelper::subWeeks($limitRight, $periodOf)->format('Y-m-d');
            // End of AI-generated code
...
function getAvailableSlots($from_date, $to_date, $provider_id = null, $facility_id = null)
{
    ...
    // Generated by GitHub Copilot - Using Carbon for timestamp conversion
    $from_datetime = DateHelper::toTimestamp($from_date . " 00:00:00");
    $to_datetime = DateHelper::toTimestamp($to_date . " 23:59:59");
    // End of AI-generated code
    $availableSlots = [];
    $start_time = 0;
    $date = 0;
    for ($i = 0; $i < count($appointments); ++$i) {
        ...
        // Generated by GitHub Copilot - Using Carbon for date comparison
        $same_day = DateHelper::isSameDay($next_appointment_date, $date);
        // End of AI-generated code

        if ($next_appointment_time && $same_day) {
            // check the start time of the next appointment
            // Generated by GitHub Copilot
            $start_datetime = DateHelper::toTimestamp($date . " " . $start_time);
            $next_appointment_datetime = DateHelper::toTimestamp($next_appointment_date . " " . $next_appointment_time);
            // End of AI-generated code
...
{
    // Generated by GitHub Copilot - Using Carbon for timestamp comparison
    use OpenEMR\Common\Utils\DateHelper;
    
    $date1 = DateHelper::toTimestamp($appointment1['pc_eventDate']);
    $date2 = DateHelper::toTimestamp($appointment2['pc_eventDate']);
    // End of AI-generated code
...
{
    // Generated by GitHub Copilot - Using Carbon for time comparison
    use OpenEMR\Common\Utils\DateHelper;
    
    $time1 = DateHelper::toTimestamp($appointment1['pc_startTime']);
    $time2 = DateHelper::toTimestamp($appointment2['pc_startTime']);
    // End of AI-generated code
...
function ends_in_a_week($end_date)
{
    ...
    $timestamp_in_a_week = DateHelper::addDays(null, 7)->timestamp;
    $timestamp_end_date = DateHelper::toTimestamp($end_date);
    // End of AI-generated code
...
function recurrence_is_current($end_date)
{
    ...
    return !DateHelper::isPast($end_date);
    // End of AI-generated code
    }
