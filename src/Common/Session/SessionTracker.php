...
class SessionTracker
{
    public static function setupSessionDatabaseTracker(): void
    {
        ...
        // Generated by GitHub Copilot - Using Carbon for date calculation
        // maintenance, remove entries that have not been updated for more than 7 days
        $expiredDateTime = DateHelper::subDays(null, 7)->format('Y-m-d H:i:s');
        // End of AI-generated code
    ...
    public static function isSessionExpired(): bool
    {
        ...
        $last_updated = DateHelper::toTimestamp($sessionTracker['last_updated']);
        $current_time = DateHelper::toTimestamp($sessionTracker['current_time']);
        // End of AI-generated code
