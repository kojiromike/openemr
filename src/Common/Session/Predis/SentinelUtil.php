...
class SentinelUtil
{
    ...
    public function __construct(private readonly ?LoggerInterface $logger = new SystemLogger())
    {
        ...
        if ($this->sessionStorageMode !== 'predis-sentinel') {
            ...
            throw new ImproperlyConfiguredException("Invalid SESSION_STORAGE_MODE. Expected 'predis-sentinel'.");
        }
        ...
        if (empty($predisSentinels)) {
            ...
            throw new ImproperlyConfiguredException("REDIS_SENTINELS environment variable is not set.");
        }
        ...
        if (empty($this->predisSentinels)) {
            ...
            throw new ImproperlyConfiguredException("REDIS_SENTINELS unable to explode any elements using the ||| delimiter.");
        }
        ...
        if ($this->predisX509 && !$this->predisTls) {
            ...
            throw new ImproperlyConfiguredException("REDIS_TLS environment variable must be set to 'yes' if REDIS_X509 is set to 'yes'.");
        }
        ...
        if ($this->predisTls && empty($this->predisSentinelCertKeyPath)) {
            ...
            throw new ImproperlyConfiguredException("REDIS_TLS_CERT_KEY_PATH environment variable is required when REDIS_TLS is set to 'yes'.");
        }
        ...
        if (!empty($this->sentinelCaFile) && !is_readable($this->sentinelCaFile)) {
            ...
            throw new ImproperlyConfiguredException("Sentinel CA file does not exist or is not readable: " . $this->sentinelCaFile);
        }
        ...
        if (!empty($this->sentinelCertFile) && !is_readable($this->sentinelCertFile)) {
            ...
            throw new ImproperlyConfiguredException("Sentinel certificate file does not exist or is not readable: " . $this->sentinelCertFile);
        }
        ...
        if (!empty($this->sentinelKeyFile) && !is_readable($this->sentinelKeyFile)) {
            ...
            throw new ImproperlyConfiguredException("Sentinel key file does not exist or is not readable: " . $this->sentinelKeyFile);
        }
        ...
        if (!empty($this->masterCaFile) && !is_readable($this->masterCaFile)) {
            ...
            throw new ImproperlyConfiguredException("Master CA file does not exist or is not readable: " . $this->masterCaFile);
        }
        ...
        if (!empty($this->masterCertFile) && !is_readable($this->masterCertFile)) {
            ...
            throw new ImproperlyConfiguredException("Master certificate file does not exist or is not readable: " . $this->masterCertFile);
        }
        ...
        if (!empty($this->masterKeyFile) && !is_readable($this->masterKeyFile)) {
            ...
            throw new ImproperlyConfiguredException("Master key file does not exist or is not readable: " . $this->masterKeyFile);
        }
