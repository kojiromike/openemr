...
class PrintProperty
{
    public static function displayProperty($title, $propertyValue, string $qualifier = "", string $ending = "", $style = ""): void
    {
        if ($propertyValue != '') {
            echo("<div class='row'>");
                echo("<div class='col'>");
    ...
    public static function displayDateProperty($title, $propertyValue): void
    {
    ...
    public static function printValidation($title, $validations): void
    {
        if ($validations != null) {
            echo("<div class='row'>");
                echo("<div class='col'>");
