...
final class TeleconferenceRoomControllerTest extends TestCase
{
    private \Comlink\OpenEMR\Modules\TeleHealthModule\Controller\TeleconferenceRoomController $teleconferenceRoomController;

    protected function setUp(): void
    {
        parent::setUp(); // TODO: Change the autogenerated stub
        $this->teleconferenceRoomController = new TeleconferenceRoomController(
    ...
    public function testInitalizeAppointmentForTelehealthWithPendingCheckinStatus(): void
    {
        ...
        $controller = $this->teleconferenceRoomController;
