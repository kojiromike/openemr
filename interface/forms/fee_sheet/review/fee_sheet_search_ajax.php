...
require_once(__DIR__ . "/fee_sheet_search_queries.php");
...
$search_type = isset($_REQUEST['search_type']) ? $_REQUEST['search_type'] : 'ICD9';

$search_type_id = isset($_REQUEST['search_type_id']) ? $_REQUEST['search_type_id'] : 2;
