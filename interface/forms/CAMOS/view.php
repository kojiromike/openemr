...
<body class="body_top">
<form method=post action="<?php echo OEGlobalsBag::getInstance()->getString('rootdir'); ?>/forms/CAMOS/save.php?mode=delete&id=<?php echo attr_url(is_string($_GET["id"] ?? null) ? $_GET["id"] : ''); ?>" name="my_form">
