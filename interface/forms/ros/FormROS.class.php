...
class FormROS extends ORDataObject
{
    ...
    public function set_weight_change($data): void
    {
        if (!empty($data)) {
    ...
    public function set_weakness($data): void
    {
        if (!empty($data)) {
            $this->weakness = $data;
        }
    ...
    public function set_fatigue($data): void
    {
        if (!empty($data)) {
            $this->fatigue = $data;
        }
    ...
    public function set_anorexia($data): void
    {
        if (!empty($data)) {
            $this->anorexia = $data;
        }
    ...
    public function set_fever($data): void
    {
        if (!empty($data)) {
            $this->fever = $data;
        }
    ...
    public function set_chills($data): void
    {
        if (!empty($data)) {
            $this->chills = $data;
        }
    ...
    public function set_night_sweats($data): void
    {
        if (!empty($data)) {
    ...
    public function set_insomnia($data): void
    {
        if (!empty($data)) {
            $this->insomnia = $data;
        }
    ...
    public function set_irritability($data): void
    {
        if (!empty($data)) {
    ...
    public function set_heat_or_cold($data): void
    {
        if (!empty($data)) {
    ...
    public function set_intolerance($data): void
    {
        if (!empty($data)) {
    ...
    public function set_change_in_vision($data): void
    {
        if (!empty($data)) {
    ...
    public function set_glaucoma_history($data): void
    {
        if (!empty($data)) {
    ...
    public function set_eye_pain($data): void
    {
        if (!empty($data)) {
            $this->eye_pain = $data;
        }
    ...
    public function set_irritation($data): void
    {
        if (!empty($data)) {
    ...
    public function set_redness($data): void
    {
        if (!empty($data)) {
            $this->redness = $data;
        }
    ...
    public function set_excessive_tearing($data): void
    {
        if (!empty($data)) {
    ...
    public function set_double_vision($data): void
    {
        if (!empty($data)) {
    ...
    public function set_blind_spots($data): void
    {
        if (!empty($data)) {
    ...
    public function set_photophobia($data): void
    {
        if (!empty($data)) {
    ...
    public function set_hearing_loss($data): void
    {
        if (!empty($data)) {
    ...
    public function set_pain($data): void
    {
        if (!empty($data)) {
            $this->pain = $data;
        }
    ...
    public function set_vertigo($data): void
    {
        if (!empty($data)) {
            $this->vertigo = $data;
        }
    ...
    public function set_tinnitus($data): void
    {
        if (!empty($data)) {
            $this->tinnitus = $data;
        }
    ...
    public function set_frequent_colds($data): void
    {
        if (!empty($data)) {
    ...
    public function set_sore_throat($data): void
    {
        if (!empty($data)) {
    ...
    public function set_sinus_problems($data): void
    {
        if (!empty($data)) {
    ...
    public function set_post_nasal_drip($data): void
    {
        if (!empty($data)) {
    ...
    public function set_nosebleed($data): void
    {
        if (!empty($data)) {
            $this->nosebleed = $data;
        }
    ...
    public function set_snoring($data): void
    {
        if (!empty($data)) {
            $this->snoring = $data;
        }
    ...
    public function set_apnea($data): void
    {
        if (!empty($data)) {
            $this->apnea = $data;
        }
    ...
    public function set_breast_mass($data): void
    {
        if (!empty($data)) {
    ...
    public function set_breast_discharge($data): void
    {
        if (!empty($data)) {
    ...
    public function set_biopsy($data): void
    {
        if (!empty($data)) {
            $this->biopsy = $data;
        }
    ...
    public function set_abnormal_mammogram($data): void
    {
        if (!empty($data)) {
    ...
    public function set_cough($data): void
    {
        if (!empty($data)) {
            $this->cough = $data;
        }
    ...
    public function set_sputum($data): void
    {
        if (!empty($data)) {
            $this->sputum = $data;
        }
    ...
    public function set_shortness_of_breath($data): void
    {
        if (!empty($data)) {
    ...
    public function set_wheezing($data): void
    {
        if (!empty($data)) {
            $this->wheezing = $data;
        }
    ...
    public function set_hemoptsyis($data): void
    {
        if (!empty($data)) {
    ...
    public function set_asthma($data): void
    {
        if (!empty($data)) {
            $this->asthma = $data;
        }
    ...
    public function set_copd($data): void
    {
        if (!empty($data)) {
            $this->copd = $data;
        }
    ...
    public function set_chest_pain($data): void
    {
        if (!empty($data)) {
    ...
    public function set_palpitation($data): void
    {
        if (!empty($data)) {
    ...
    public function set_syncope($data): void
    {
        if (!empty($data)) {
            $this->syncope = $data;
        }
    ...
    public function set_pnd($data): void
    {
        if (!empty($data)) {
            $this->pnd = $data;
        }
    ...
    public function set_doe($data): void
    {
        if (!empty($data)) {
            $this->doe = $data;
        }
    ...
    public function set_orthopnea($data): void
    {
        if (!empty($data)) {
            $this->orthopnea = $data;
        }
    ...
    public function set_peripheal($data): void
    {
        if (!empty($data)) {
            $this->peripheal = $data;
        }
    ...
    public function set_edema($data): void
    {
        if (!empty($data)) {
            $this->edema = $data;
        }
    ...
    public function set_legpain_cramping($data): void
    {
        if (!empty($data)) {
    ...
    public function set_history_murmur($data): void
    {
        if (!empty($data)) {
    ...
    public function set_arrythmia($data): void
    {
        if (!empty($data)) {
            $this->arrythmia = $data;
        }
    ...
    public function set_heart_problem($data): void
    {
        if (!empty($data)) {
    ...
    public function set_polyuria($data): void
    {
        if (!empty($data)) {
            $this->polyuria = $data;
        }
    ...
    public function set_polydypsia($data): void
    {
        if (!empty($data)) {
    ...
    public function set_dysuria($data): void
    {
        if (!empty($data)) {
            $this->dysuria = $data;
        }
    ...
    public function set_hematuria($data): void
    {
        if (!empty($data)) {
            $this->hematuria = $data;
        }
    ...
    public function set_frequency($data): void
    {
        if (!empty($data)) {
            $this->frequency = $data;
        }
    ...
    public function set_urgency($data): void
    {
        if (!empty($data)) {
            $this->urgency = $data;
        }
    ...
    public function set_incontinence($data): void
    {
        if (!empty($data)) {
    ...
    public function set_renal_stones($data): void
    {
        if (!empty($data)) {
    ...
    public function set_utis($data): void
    {
        if (!empty($data)) {
            $this->utis = $data;
        }
    ...
    public function set_hesitancy($data): void
    {
        if (!empty($data)) {
            $this->hesitancy = $data;
        }
    ...
    public function set_dribbling($data): void
    {
        if (!empty($data)) {
            $this->dribbling = $data;
        }
    ...
    public function set_stream($data): void
    {
        if (!empty($data)) {
            $this->stream = $data;
        }
    ...
    public function set_nocturia($data): void
    {
        if (!empty($data)) {
            $this->nocturia = $data;
        }
    ...
    public function set_erections($data): void
    {
        if (!empty($data)) {
            $this->erections = $data;
        }
    ...
    public function set_ejaculations($data): void
    {
        if (!empty($data)) {
    ...
    public function set_g($data): void
    {
        if (!empty($data)) {
            $this->g = $data;
        }
    ...
    public function set_p($data): void
    {
        if (!empty($data)) {
            $this->p = $data;
        }
    ...
    public function set_ap($data): void
    {
        if (!empty($data)) {
            $this->ap = $data;
        }
    ...
    public function set_lc($data): void
    {
        if (!empty($data)) {
            $this->lc = $data;
        }
    ...
    public function set_mearche($data): void
    {
        if (!empty($data)) {
            $this->mearche = $data;
        }
    ...
    public function set_menopause($data): void
    {
        if (!empty($data)) {
            $this->menopause = $data;
        }
    ...
    public function set_lmp($data): void
    {
        if (!empty($data)) {
            $this->lmp = $data;
        }
    ...
    public function set_f_frequency($data): void
    {
        if (!empty($data)) {
    ...
    public function set_f_flow($data): void
    {
        if (!empty($data)) {
            $this->f_flow = $data;
        }
    ...
    public function set_f_symptoms($data): void
    {
        if (!empty($data)) {
    ...
    public function set_abnormal_hair_growth($data): void
    {
        if (!empty($data)) {
    ...
    public function set_f_hirsutism($data): void
    {
        if (!empty($data)) {
    ...
    public function set_joint_pain($data): void
    {
        if (!empty($data)) {
    ...
    public function set_swelling($data): void
    {
        if (!empty($data)) {
            $this->swelling = $data;
        }
    ...
    public function set_m_redness($data): void
    {
        if (!empty($data)) {
            $this->m_redness = $data;
        }
    ...
    public function set_m_warm($data): void
    {
        if (!empty($data)) {
            $this->m_warm = $data;
        }
    ...
    public function set_m_stiffness($data): void
    {
        if (!empty($data)) {
    ...
    public function set_muscle($data): void
    {
        if (!empty($data)) {
            $this->muscle = $data;
        }
    ...
    public function set_m_aches($data): void
    {
        if (!empty($data)) {
            $this->m_aches = $data;
        }
    ...
    public function set_fms($data): void
    {
        if (!empty($data)) {
            $this->fms = $data;
        }
    ...
    public function set_arthritis($data): void
    {
        if (!empty($data)) {
            $this->arthritis = $data;
        }
    ...
    public function set_loc($data): void
    {
        if (!empty($data)) {
            $this->loc = $data;
        }
    ...
    public function set_seizures($data): void
    {
        if (!empty($data)) {
            $this->seizures = $data;
        }
    ...
    public function set_stroke($data): void
    {
        if (!empty($data)) {
            $this->stroke = $data;
        }
    ...
    public function set_tia($data): void
    {
        if (!empty($data)) {
            $this->tia = $data;
        }
    ...
    public function set_n_numbness($data): void
    {
        if (!empty($data)) {
    ...
    public function set_n_weakness($data): void
    {
        if (!empty($data)) {
    ...
    public function set_paralysis($data): void
    {
        if (!empty($data)) {
            $this->paralysis = $data;
        }
    ...
    public function set_intellectual_decline($data): void
    {
        if (!empty($data)) {
    ...
    public function set_memory_problems($data): void
    {
        if (!empty($data)) {
    ...
    public function set_dementia($data): void
    {
        if (!empty($data)) {
            $this->dementia = $data;
        }
    ...
    public function set_n_headache($data): void
    {
        if (!empty($data)) {
    ...
    public function set_s_cancer($data): void
    {
        if (!empty($data)) {
            $this->s_cancer = $data;
        }
    ...
    public function set_psoriasis($data): void
    {
        if (!empty($data)) {
            $this->psoriasis = $data;
        }
    ...
    public function set_s_acne($data): void
    {
        if (!empty($data)) {
            $this->s_acne = $data;
        }
    ...
    public function set_s_other($data): void
    {
        if (!empty($data)) {
            $this->s_other = $data;
        }
    ...
    public function set_s_disease($data): void
    {
        if (!empty($data)) {
            $this->s_disease = $data;
        }
    ...
    public function set_p_diagnosis($data): void
    {
        if (!empty($data)) {
    ...
    public function set_p_medication($data): void
    {
        if (!empty($data)) {
    ...
    public function set_depression($data): void
    {
        if (!empty($data)) {
    ...
    public function set_anxiety($data): void
    {
        if (!empty($data)) {
            $this->anxiety = $data;
        }
    ...
    public function set_social_difficulties($data): void
    {
        if (!empty($data)) {
    ...
    public function set_thyroid_problems($data): void
    {
        if (!empty($data)) {
    ...
    public function set_diabetes($data): void
    {
        if (!empty($data)) {
            $this->diabetes = $data;
        }
    ...
    public function set_abnormal_blood($data): void
    {
        if (!empty($data)) {
    ...
    public function set_anemia($data): void
    {
        if (!empty($data)) {
            $this->anemia = $data;
        }
    ...
    public function set_fh_blood_problems($data): void
    {
        if (!empty($data)) {
    ...
    public function set_bleeding_problems($data): void
    {
        if (!empty($data)) {
    ...
    public function set_allergies($data): void
    {
        if (!empty($data)) {
            $this->allergies = $data;
        }
    ...
    public function set_frequent_illness($data): void
    {
        if (!empty($data)) {
    ...
    public function set_hiv($data): void
    {
        if (!empty($data)) {
            $this->hiv = $data;
        }
    ...
    public function set_hai_status($data): void
    {
        if (!empty($data)) {
    ...
    {
        return array("N/A" => xlt('N/A'),"YES" => xlt('YES'),"NO" => xlt('NO'));
    }
    ...
    public function set_dysphagia($data): void
    {
        if (!empty($data)) {
            $this->dysphagia = $data;
        }
    ...
    public function set_heartburn($data): void
    {
        if (!empty($data)) {
            $this->heartburn = $data;
        }
    ...
    public function set_bloating($data): void
    {
        if (!empty($data)) {
            $this->bloating = $data;
        }
    ...
    public function set_belching($data): void
    {
        if (!empty($data)) {
            $this->belching = $data;
        }
    ...
    public function set_flatulence($data): void
    {
        if (!empty($data)) {
    ...
    public function set_nausea($data): void
    {
        if (!empty($data)) {
            $this->nausea = $data;
        }
    ...
    public function set_vomiting($data): void
    {
        if (!empty($data)) {
            $this->vomiting = $data;
        }
    ...
    public function set_hematemesis($data): void
    {
        if (!empty($data)) {
    ...
    public function set_gastro_pain($data): void
    {
        if (!empty($data)) {
    ...
    public function set_food_intolerance($data): void
    {
        if (!empty($data)) {
    ...
    public function set_hepatitis($data): void
    {
        if (!empty($data)) {
            $this->hepatitis = $data;
        }
    ...
    public function set_jaundice($data): void
    {
        if (!empty($data)) {
            $this->jaundice = $data;
        }
    ...
    public function set_hematochezia($data): void
    {
        if (!empty($data)) {
    ...
    public function set_changed_bowel($data): void
    {
        if (!empty($data)) {
    ...
    public function set_diarrhea($data): void
    {
        if (!empty($data)) {
            $this->diarrhea = $data;
        }
    ...
    public function set_constipation($data): void
    {
        if (!empty($data)) {
