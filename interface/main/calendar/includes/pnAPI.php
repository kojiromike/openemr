...
function pnInit()
{
    ...
    // ADODB configuration - now using existing OpenEMR connection via get_db()
    // No longer need to require adodb.inc.php as it's already loaded by OpenEMR
...
function pnDBInit()
{
    // Use the existing OpenEMR database connection instead of creating a new one
    global $dbconn;
    $dbconn = get_db();
