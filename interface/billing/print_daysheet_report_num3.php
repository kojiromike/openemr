...
// sort array in assending order
    ...
    foreach ($all4 as $iter) {
        ...
        if ($totals_only != 1) {
            if ($old_pid != $iter['pid'] && $iter['code_type'] != 'payment_info') {
               ...
               //
                ...
                if ($old_pid == $new_old_pid) {
                    if ($line_total != 0) {
                        ...
                        Printf('<br /></span></td><td class=\'w-100\'><span class=\'text\'><center> %1$.2f', text($line_total));
                    } else {
                        print "<td class='w-100'><br /><span class='text'><strong><center>" . xlt('Total') . "</strong></center>";
                        Printf('<br /></span></td><td class=\'w-100\'><span class=\'text\'><center> %1$.2f', text($line_total_pay));
                    }
            ...
            if ($iter['code_type'] != 'payment_info') {
                if ($iter['code_type'] === 'COPAY' || $iter['code_type'] === 'Patient Payment' || $iter['code_type'] === 'Insurance Payment') {
                    ...
                    if ($iter['ins_adjust_dollar'] != 0 && $iter['code_type'] === 'Insurance Payment') {
                    ...
                    if ($iter['pat_code'] != 0 && $iter['code_type'] === 'Patient Payment') {
                    ...
                    if ($iter['pat_code'] > 0 && $iter['code_type'] === 'Patient Payment' && $iter['paytype'] != 'PCP') {
                    ...
                    if ($iter['code_type'] != 'Insurance Payment' && $iter['code_type'] != 'Patient Payment' && $iter['paytype'] != 'PCP') {
                    ...
                    print  "</span></td>\n";
                } elseif (date("Y-m-d", strtotime($iter['bill_date'])) === "1969-12-31") {
                ...
                if ($old_pid != $new_old_pid && $iter['code_type'] != 'payment_info') {
                    $new_old_pid = $old_pid;
                }
            }
        }
...
for ($i = 1; $i < $k;) {
    ...
    Printf("<td width='70'><span class='text'><strong><center>" . xlt("User") . ' ' . "</center></strong><center>" . text($user_info['user'][$i]));
    Printf("<td width='140'><span class='text'><strong><center>" . xlt("Charges") . ' ' . "</center></strong><center>" . " %1\$.2f", text($user_info['fee'][$i]));
    Printf("<td width='140'><span class='text'><strong><center>" . xlt("Insurance Adj") . '. ' . "</center></strong><center>" . "%1\$.2f", text($user_info['insadj'][$i]));
    Printf("<td width='140'><span class='text'><strong><center>" . xlt("Insurance Payments") . ' ' . "</center></strong><center>" . "%1\$.2f", text($user_info['inspay'][$i]));
    Printf("<td width='140'><span class='text'><strong><center>" . xlt("Patient Adj") . '. ' . "</center></strong><center>" . "%1\$.2f", text($user_info['patadj'][$i]));
    Printf("<td width='140'><span class='text'><strong><center>" . xlt("Patient Payments") . ' ' . "</center></strong><center>" . "%1\$.2f", text($user_info['patpay'][$i]));
...
Printf("<td width='140'><span class='text'><strong><center>" . xlt("Total Charges") . ' ' . "</center></strong><center>" . " %1\$.2f", text($gtotal_fee));
Printf("<td width='140'><span class='text'><strong><center>" . xlt("Insurance Adj") . '. ' . "</center></strong><center>" . "%1\$.2f", text($gtotal_insadj));
Printf("<td width='140'><span class='text'><strong><center>" . xlt("Insurance Payments") . ' ' . "</center></strong><center>" . "%1\$.2f", text($gtotal_inspay));
Printf("<td width='140'><span class='text'><strong><center>" . xlt("Patient Adj") . '.' . "</center></strong><center>" . "%1\$.2f", text($gtotal_patadj));
Printf("<td width='140'><span class='text'><strong><center>" . xlt("Patient Payments") . ' ' . "</center></strong><center>" . "%1\$.2f", text($gtotal_patpay));
