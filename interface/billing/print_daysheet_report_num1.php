                    ...
                    if ($totals_only != 1) {
                        ...
                        if ($iter['code_type'] != 'payment_info') {
                            if ($iter['code_type'] === 'COPAY' || $iter['code_type'] === 'Patient Payment' || $iter['code_type'] === 'Insurance Payment') { ?>
                                ...
                                <?php if ($iter['ins_adjust_dollar'] != 0 && $iter['code_type'] === 'Insurance Payment') { ?>
                                ...
                                <?php if ($iter['ins_code'] > 0 && $iter['code_type'] === 'Insurance Payment') { ?>
                                    <td class='text' width='180'>
                                        <?php echo xlt('Insurance Payment'); ?>
                                    </td>
                                <?php } ?>

                                <?php if ($iter['pat_code'] > 0 && $iter['code_type'] === 'Patient Payment' && $iter['paytype'] != 'PCP') { ?>
                                    <td class='text' width='180'>
                                ...
                                <?php if ($iter['code_type'] != 'Patient Payment' && $iter['code_type'] != 'Insurance Payment') {
                                ...
                                <?php if ($iter['pat_adjust_dollar'] != 0 && $iter['code_type'] === 'Patient Payment') {
                                ...
                                <?php if ($iter['pat_code'] != 0 && $iter['code_type'] === 'Patient Payment') {
                                ...
                                <?php if ($iter['code_type'] != 'Insurance Payment' && $iter['code_type'] != 'Patient Payment' && $iter['paytype'] != 'PCP') { ?>
                                    <td class='text' width='100'>
